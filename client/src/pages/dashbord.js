...
const CheckInOutPage = () => {
  ...
  const handleCheckIn = async () => {
    ...
    try {
      const res = await axios.post("https://attendance-9ifj.onrender.com/api/checkin", {
        userId: userId,
  ...
  const handleCheckOut = async () => {
    ...
    try {
      console.log(historyId);
      const response = await axios.post("https://attendance-9ifj.onrender.com/api/checkout", {
        historyId: historyId,
        timestamp: currentTime
      });
