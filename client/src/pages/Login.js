...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://tech-54ds.onrender.com/api/user/login', form);
    ...
    return (
        <div className='container-1'>
            ...
            <form className='form-login-1' onSubmit={handleSubmit}>
                <div className='logoImage-1'>
                    <div className='fake-input-1 my-3'>
                        <img className='rounded-circle' src='attendanceImage/email.svg' width='22' alt="Email icon" />
                        <input
                            type='email'
                    ...
                    <div className='fake-input-1'>
                        <img className='rounded-circle' src='attendanceImage/password.svg' width='22' alt="Password icon" />
                        <input
                            type='password'
                            className='form-control-1 px-5'
                    ...
                    <div className='logoImage-1 my-3'>
                        <button className='buttonLogin-1' type='submit'>Login</button>
                    </div>
            ...
            <div className='logoImage-1 mt-2'>
                <Link to='/signup' className='link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100'>Register</Link>
            </div>
            <div className='logoImage-1'>
